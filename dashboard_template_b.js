...
function renderSectors() {
  document.getElementById('sector-grid').innerHTML = ACTIVE.sectors.map((s,i)=>{
    ...
    const ROT_LABELS = {
      IN:      {cls:'rotation-in',      arrow:'↑', label:'ROTATING IN',  caption:'Composite has expanded vs 4 weeks ago'},
      STABLE:  {cls:'rotation-stable',  arrow:'→', label:'STABLE',        caption:'Composite roughly unchanged vs 4 weeks ago'},
      OUT:     {cls:'rotation-out',     arrow:'↓', label:'ROTATING OUT', caption:'Composite has contracted vs 4 weeks ago'},
